...
Both are installed. tmux is the established standard; zellij is the modern alternative with a discoverable UI.
...
**Clipboard integration:** The tmux config uses `xclip` on Linux:
